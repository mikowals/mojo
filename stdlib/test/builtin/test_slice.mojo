...
def test_slicable():
    ...
    var funny = slicable[1:"hello":4.0]
    assert_equal(funny.start, 1)
    assert_equal(funny.upper, "hello")
    assert_equal(funny.stride, 4.0)

    var boring = slicable[1:2:"foo"]
    assert_equal(boring.a, 1)
    assert_equal(boring.b, 2)
    assert_equal(boring.c, "foo")
